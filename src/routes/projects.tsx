...
const snippets = [
  {
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/53454330580_a754211f15_k.jpg",
  ...
  },
  {
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/53453915506_a6ee5ec899_h.jpg",
  ...
  },
  {
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/53522237177_8ffbc5dc64_k.jpg",
  ...
  },
  {
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/53641516895_18e82c9df5_h.jpg",
  ...
  },
  {
    ...
    path: "/snippets/water",
    imageUrl:
      "https://live.staticflickr.com/65535/53914487061_c13c24abdf_h.jpg",
  ...
  },
  {
    ...
    path: "/snippets/vfd",
    imageUrl:
      "https://live.staticflickr.com/65535/54086978014_65b06268c5_h.jpg",
...
const projects = [
  {
    title: "City demo",
    url: "https://veikkosuhonen.github.io/Grid-Attack",
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/54305234064_d531489e5e_h.jpg",
    text: "A procedural city demonstrating some deferred rendering techniques and effects. Won 1st place at Assembly 2025 One Scene demo competition.",
  },
  {
    title: "FBM Lab",
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/54305465695_88e475d653_h.jpg",
  ...
  },
  {
    ...
    imageUrl:
      "https://live.staticflickr.com/65535/54305425270_5d1f41bca2_h.jpg",
    text: "Visualizing source code relations and code ownership: an interactive data visualization project",
  },
  {
    title: "Broken Game of Life",
    url: "https://veikkosuhonen.github.io/broken-gol/",
    // <a data-flickr-embed="true" href="https://www.flickr.com/photos/199880417@N08/54783344167/in/dateposted-public/" title="out"><img src="https://live.staticflickr.com/65535/54783344167_c38fd4f420_b.jpg" width="918" height="670" alt="out"/></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
    imageUrl:
      "https://live.staticflickr.com/65535/54783344167_c38fd4f420_b.jpg",
    text: "Accidentally made some cool glitch art while implementing Game of Life using WebGPU",
  },
];
...
const ImageLink: Component<{
  ...
  return (
    <div
      class="overflow-visible w-100 h-100 font-serif"
      ref={cardElement}
...
const ProjectCard: Component<{
  ...
  return (
    <div class="aspect-[3/2] w-80">
      ...
      />
      <animated.p
        class="text-slate-200 font-light rounded-lg p-4 mt-2 -z-10"
        style={styles()}
      >
        {props.text}
      </animated.p>
    ...
    <>
      ...
      <main class="flex-grow relative mt-12 mx-2">
        <article class="container mx-auto">
          <h1 class="text-6xl font-serif mt-8">Project Showcase</h1>
          <h2 class="text-3xl font-serif mt-8">Fun projects online</h2>
          <p class="text-slate-200 mb-8 mt-8 w-96 font-light">
            I like making stuff available in the public web if I can. Here's a
            few personal "research" projects I've made that you can try out.
          </p>
          <section>
          ...
          <h2 class="text-3xl font-serif mt-8">Snippets</h2>
          <p class="text-slate-200 mb-8 mt-8 w-96 font-light">
            Some graphics-related web experiments I've put on this website. All
            source code is in the{" "}
            <a
              href="https://github.com/Veikkosuhonen/veikkosuhonen/blob/master/src/experiments"
              class="text-sunset-300 underline"
            >
              website's repo
            </a>
          </p>
